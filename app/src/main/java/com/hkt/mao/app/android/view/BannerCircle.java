package com.hkt.mao.app.android.view;
...
public class BannerCircle extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.banner_home;
    ...
    public BannerCircle(Context context) {
        this(context, null);
    }

    public BannerCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerCircle(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BannerCircle isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerCircle setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerCircle setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerCircle setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerCircle setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerCircle setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerCircle setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerCircle setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerCircle setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerCircle setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerCircle setImages(List<?> imageUrls) {
    ...
    private void setData() {
        ...
        viewPager.setPageMargin(getResources().getDimensionPixelSize(R.dimen.dimens_10_dp));
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public BannerCircle setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BannerCircle setOnBannerListener(OnBannerListener listener) {
