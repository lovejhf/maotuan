...
public class SlidingTabLayoutView extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayoutView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setGravity(Gravity.BOTTOM);
